...
<template>
    ...
    <AdminLayout>
        <div class="admin-form-page">
            ...
            <form @submit.prevent="submit" class="admin-form-card">
                ...
                <div class="pt-4">
                    <button
                        ...
                        class="w-full btn-primary !py-5 !rounded-2xl flex items-center justify-center gap-3 group transition-all active:scale-[0.98]"
                    >
            ...
            <div class="flex items-start gap-4 p-6 bg-slate-50 dark:bg-dark-bg rounded-[2rem] border border-slate-100 dark:border-dark-border">
