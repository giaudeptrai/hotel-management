        ...
        <div class="admin-form-page">
            ...
            <form @submit.prevent="submit" class="admin-form-card">
                ...
                <div class="space-y-3">
                    ...
                    <input
                        ...
                        class="form-input-pms placeholder:font-medium"
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative group">
                            <input
                                ...
                                type="number"
                                class="form-input-pms input-number-clean !font-black"
                            >
                ...
                <div class="pt-4 flex items-center gap-3">
                    <button
                        ...
                        class="flex-1 btn-primary !py-5 !rounded-2xl flex items-center justify-center gap-3 group transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                    >
            ...
            <div class="flex items-start gap-4 p-6 bg-slate-50 dark:bg-dark-border/30 rounded-[2rem] border border-slate-100 dark:border-dark-border">
                ...
                <p class="text-xs text-muted-text font-medium leading-relaxed">
                    ...
                    Mọi thay đổi về tên sẽ tự động cập nhật lại <span class="font-mono text-primary-600">slug</span> (đường dẫn) thông qua Service.
